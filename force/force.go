...
func Create(version, clientID, clientSecret, userName, password, securityToken, environment string) (*API, error) {
	oauth := &oauth{
		clientID:      clientID,
...
// CreateWithAccessToken creates a new API instance with access token
...
// APILogger is a logger interface
